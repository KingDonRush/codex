...
pub const ANTHROPIC_DEFAULT_MODEL_ID: &str = "claude-sonnet-4-6";
...
impl ModelProviderInfo {
    ...
    pub fn create_anthropic_provider() -> ModelProviderInfo {
        ModelProviderInfo {
            ...
            env_key_instructions: Some(
                "Set ANTHROPIC_API_KEY to an Anthropic Console API key.".into(),
            ),
            experimental_bearer_token: None,
            auth: None,
            aws: None,
            ...
            http_headers: Some(HashMap::from([(
                ...
                ANTHROPIC_VERSION_VALUE.to_string(),
            )])),
            env_http_headers: None,
            request_max_retries: None,
            stream_max_retries: None,
    ...
    pub fn is_anthropic(&self) -> bool {
        self.name == ANTHROPIC_PROVIDER_NAME || self.wire_api == WireApi::AnthropicMessages
    }
